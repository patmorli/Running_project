...
# some directories
dir_root = "/Users/patrick/Library/CloudStorage/GoogleDrive-patrick.mayerhofer@locomotionlab.com/My Drive/Running Plantiga Project/Code/time_series_tfrecords_example/"
dir_raw_data = dir_root + "data/"
dir_prepared = dir_root + 'working/'


files = np.sort(glob.glob(dir_raw_data + '*/*'))
...
output_list_df.shape

#output_list_df.tail()

output_list_df.to_parquet(dir_prepared + "/parquet_data.parquet")

full_dataset_parquet = pd.read_parquet(dir_prepared + "parquet_data.parquet")
...
#full_dataset_parquet['samples'][0]

#[x['accelerometer_X'] for x in full_dataset_parquet['samples'][0]]
...
#create_example(full_dataset_parquet.loc[0])

#full_dataset_parquet.shape[0]
...
tfrecords_dir = dir_prepared + '/tfrecords'
