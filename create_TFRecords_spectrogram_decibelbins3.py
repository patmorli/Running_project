...
noverlap=500 #462 for 251, 251; 1080 for 223, 223 but f and Sxx need adjustments
...
dir_save = dir_tfr + "25k_"+ str(nperseg) + '_' + str(noverlap) + "_bins2_onespeed/"
#dir_save = dir_tfr + '10k_no_spectrogram/'
    ...
    for dir_file_number in range(len(dir_files)):
        ...
        if flag_all_speeds == 0:
            if flag_spectrogram:
                ...
                "Takes df_cur (12 features) as input and prepares data to save as tfrecord"
